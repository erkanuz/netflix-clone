...
export const Footer = () => {
  return (
    <div className='flex flex-col items-center w-full pt-20'>
      ...
      <div className='grid sm:grid-cols-4 grid-cols-2 sm:text-base text-xs leading-6 sm:space-x-10 space-x-0 gap-10 sm:gap-0 mx-auto'>
        <ul>
      ...
      <div className='flex items-center bg-gray-700 outline outline-white rounded-md px-2 w-28 my-10'>
        <GiWorld size={20} />
        <select name="format" className='text-white bg-gray-700 outline-none'>
